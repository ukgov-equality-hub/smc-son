...
::: tabs
        ...
        ::: visualisation vis_type="chart" section_name="By disadvantage status over time"
            {
                ...
                "tooltipTitle": "",
                "data": "3.0/IN12-3.0-attainment-at-age-11--by-year-and-disadvantage--chart-format.csv",
                "height": 450,
                "type": "bary",
    ...
    ::: tab section_name="By disadvantage status over time" tab_name="Data"
        ::: data_table
            {
                "title": "Percentage of pupils meeting the expected standard in reading, writing and maths by the end of key stage 2, by disadvantage status over time (England, September 2015 to July 2024)",
                "dataTable": "3.0/IN12-3.0-attainment-at-age-11--by-year-and-disadvantage--table-format.csv",
...
::: tabs
        ...
        ::: visualisation vis_type="chart" section_name="By year"
            {
                ...
                "tooltipTitle": "",
                "data": "3.0/IN12-3.0-attainment-at-age-11--by-year-gap--chart-format.csv",
                "height": 450,
                "type": "liney",
    ...
    ::: tab section_name="By year" tab_name="Data"
        ::: data_table
            {
                "title": "Disadvantage attainment gap index over time (England, September 2010 to July 2024)",
                "dataTable": "3.0/IN12-3.0-attainment-at-age-11--by-year-gap--table-format.csv",
...
::: tabs
        ...
        ::: visualisation vis_type="map" section_name="By area"
            {
                ...
                "data": [{
                    "label": "FSM eligible",
                    "data": "3.0/IN12-3.0-attainment-at-age-11--by-ITL2-region-and-FSM--FSM-eligible--chart-format.csv"
                }, {
                    "label": "Not FSM eligible",
                    "data": "3.0/IN12-3.0-attainment-at-age-11--by-ITL2-region-and-FSM--Not-FSM-eligible--chart-format.csv"
                }],
                "toggle": "radio",
                "geoFormat": "",
                "nameField": "area_name",
    ...
    ::: tab section_name="By area" tab_name="Data"
        ::: data_table
            {
                "title": "Percentage of students meeting the expected standard in reading, writing and maths by the end of key stage 2, by region and eligibility for free school meals (FSM) (England, school year 2023 to 2024)",
                "dataTable": "3.0/IN12-3.0-attainment-at-age-11--by-ITL2-region-and-FSM--table-format.csv",
                "dataTableAlignColumns": ["left", "right", "right", "right"],
...
::: tabs
        ...
        ::: visualisation vis_type="chart" section_name="By sex"
            {
                ...
                "tooltipTitle": "",
                "data": "3.0/IN12-3.0-attainment-at-age-11--by-sex-and-disadvantage--chart-format.csv",
                "height": 450,
                "type": "bary",
    ...
    ::: tab section_name="By sex" tab_name="Data"
        ::: data_table
            {
                "title": "Percentage of pupils meeting the expected standard in reading, writing and maths by the end of key stage 2, by disadvantage status and sex (England, school year 2023 to 2024)",
                "dataTable": "3.0/IN12-3.0-attainment-at-age-11--by-sex-and-disadvantage--table-format.csv",
...
::: tabs
        ...
        ::: visualisation vis_type="chart" section_name="By ethnicity"
            {
                ...
                "tooltipTitle": "",
                "data": "3.0/IN12-3.0-attainment-at-age-11--by-ethnicity--chart-format.csv",
                "height": 600,
                "type": "bar",
                "xkey": "value",
    ...
    ::: tab section_name="By ethnicity" tab_name="Data"
        ::: data_table
            {
                "title": "Percentage of FSM-eligible pupils meeting the expected standard in reading, writing and maths by the end of key stage 2, by ethnicity (England, school year 2023 to 2024)",
                "dataTable": "3.0/IN12-3.0-attainment-at-age-11--by-ethnicity--table-format.csv",
                "dataTableAlignColumns": ["left", "right", "right"]
            }
        :::
    :::
...
::: download_full_dataset_link data_file="3.0/IN12-3.0-attainment-at-age-11--full-dataset.csv" :::
