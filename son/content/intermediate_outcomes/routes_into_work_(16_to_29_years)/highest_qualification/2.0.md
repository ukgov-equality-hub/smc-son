...
There is a strong relationship between people's socio-economic background and the highest qualification they get by their mid to late 20s. These inequalities are bigger for higher (master's) degrees than for first (bachelor’s) degrees.
...
Young women from nearly every socio-economic background were more likely to have a first degree than young men from the same socio-economic background. They were also less likely to have lower-level qualifications.
