...
* young men earned more than young women
...
::: tabs
    ::: tab section_name="By socio-economic background" tab_name="Visualisation"
        #### Mean (average) hourly earnings of people aged 25 to 29 years, by socio-economic background (UK, 2022)
    ...
    ::: tab section_name="By socio-economic background" tab_name="Data"
        ::: data_table
            {
                "title": "Mean (average) hourly earnings of people aged 25 to 29 years, by socio-economic background (UK, 2022)",
...
::: tabs
    ::: tab section_name="By area" tab_name="Visualisation"
        #### Difference in weekly earnings in pounds (£) of 25 to 29 year olds, compared to the national average (UK, 2018 to 2022 combined) {: class="govuk-!-margin-bottom-4"}
    ...
    ::: tab section_name="By area" tab_name="Data"
        ::: data_table
            {
                "title": "Difference in weekly earnings in pounds (£) of 25 to 29 year olds, compared to the national average (UK, 2018 to 2022 combined)",
...
::: tabs
    ::: tab section_name="By sex" tab_name="Visualisation"
        #### Mean (average) hourly earnings of people aged 25 to 29 years, by socio-economic background and sex (UK, 2014 to 2022 combined)
    ...
    ::: tab section_name="By sex" tab_name="Data"
        ::: data_table
            {
                "title": "Mean (average) hourly earnings of people aged 25 to 29 years, by socio-economic background and sex (UK, 2014 to 2022 combined)",
...
::: tabs
    ::: tab section_name="By ethnicity" tab_name="Visualisation"
        #### Mean (average) hourly earnings of people aged 25 to 29 years, by socio-economic background and ethnicity (UK, 2014 to 2022 combined)
    ...
    ::: tab section_name="By ethnicity" tab_name="Data"
        ::: data_table
            {
                "title": "Mean (average) hourly earnings of people aged 25 to 29 years, by socio-economic background and ethnicity (UK, 2014 to 2022 combined)",
...
::: tabs
    ::: tab section_name="By disability status" tab_name="Visualisation"
        #### Mean (average) hourly earnings of people aged 25 to 29 years, by socio-economic background and disability (UK, 2014 to 2022 combined)
    ...
    ::: tab section_name="By disability status" tab_name="Data"
        ::: data_table
            {
                "title": "Mean (average) hourly earnings of people aged 25 to 29 years, by socio-economic background and disability (UK, 2014 to 2021 combined)",
...
## About the data
This page contains new analysis written for State of the Nation based on data from the following source(s):
...
The estimated means and confidence intervals come from a linear regression model of log hourly earnings. This includes variables on socio-economic background, sex and ethnic group.

For data by ethnicity, the model assumes that class effects are the same within each ethnic group. However, the assumption does not hold for the White Other group. The percentages shown are those for men. Percentages are shown only for those with lower working-class and higher professional-class backgrounds, but other socio-economic backgrounds are included in the analysis.

Among people with a disability, those in work are a more selective group because their inactivity rate is higher. Because of the skewed distribution of earnings, we take the log of earnings when checking for links between disability and socio-economic backgrounds. We did not find a significant link using this model.
