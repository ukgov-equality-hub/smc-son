...
::: tabs
    ::: tab section_name="By disadvantage status over time" tab_name="Visualisation"
        ...
        ::: visualisation vis_type="chart" section_name="By disadvantage status over time"
            {
                "code": "IN12",
                "title": "Percentage of pupils meeting the expected standard in reading, writing and maths by the end of key stage 2, by disadvantage status over time (England, 9 school years to July 2024)",
                "tooltipTitle": "",
