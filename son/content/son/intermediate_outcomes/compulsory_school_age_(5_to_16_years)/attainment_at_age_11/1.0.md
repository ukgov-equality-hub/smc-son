...
::: tabs
        ...
        ::: visualisation vis_type="chart" section_name="By disadvantage status over time"
            {
                ...
                "tooltipTitle": "",
                "data": "1.0/IN12_overview-20230531.csv",
                "height": 450,
                "type": "bary",
                "xkey": "SEB",
                "ykey": "Value",
    ...
    ::: tab section_name="By disadvantage status over time" tab_name="Data"
        ::: data_table
            {
                "title": "Percentage of pupils meeting the expected standard in reading, writing and maths at key stage 2, by disadvantage status over time (England, September 2015 to July 2022)",
                "dataTable": "1.0/IN12-attainment-at-age-11--by-year-and-disadvantage--table-format.csv",
...
::: tabs
        ...
        ::: visualisation vis_type="chart" section_name="By year"
            {
                ...
                "tooltipTitle": "",
                "data": "1.0/IN12_year-20230531.csv",
                "height": 450,
                "type": "liney",
                "xkey": "Time_period",
                "ykey": "Value",
    ...
    ::: tab section_name="By year" tab_name="Data"
        ::: data_table
            {
                "title": "Disadvantage attainment gap index over time (England, September 2010 to July 2022)",
                "dataTable": "1.0/IN12-attainment-at-age-11--gap-by-year--table-format.csv",
...
::: tabs
        ...
        ::: visualisation vis_type="map" section_name="By area"
            {
                ...
                "data": [{
                    "label": "FSM eligible",
                    "data": "1.0/IN12_area_fsm_eligible-20230531.csv"
                }, {
                    "label": "Not FSM eligible",
                    "data": "1.0/IN12_area_not_fsm_eligible-20230531.csv"
                }],
                "toggle": "radio",
                "geoFormat": "",
                "nameField": "Area_name",
    ...
    ::: tab section_name="By area" tab_name="Data"
        ::: data_table
            {
                "title": "Percentage of students meeting the expected standard in reading, writing and maths by the end of key stage 2, by region and eligibility for free school meals (FSM) (England, September 2012 to July 2022)",
                "dataTable": "1.0/IN12-attainment-at-age-11--by-ITL2-region-and-FSM--table-format.csv",
                "dataTableAlignColumns": ["left", "right", "right", "right"],
...
::: tabs
        ...
        ::: visualisation vis_type="chart" section_name="By sex"
            {
                ...
                "tooltipTitle": "",
                "data": "1.0/IN12_gender-20230419.csv",
                "height": 450,
                "type": "bary",
                "xkey": "SEB",
                "ykey": "Value",
    ...
    ::: tab section_name="By sex" tab_name="Data"
        ::: data_table
            {
                "title": "Percentage of pupils meeting the expected standard in reading, writing and maths at key stage 2, by disadvantage status and sex (England, school year 2021 to 2022)",
                "dataTable": "1.0/IN12-attainment-at-age-11--by-sex-and-disadvantage--table-format.csv",
...
::: tabs
        ...
        ::: visualisation vis_type="chart" section_name="By ethnicity"
            {
                ...
                "tooltipTitle": "",
                "data": "1.0/IN12_ethnicity_fsm_202122-20230531.csv",
                "height": 600,
                "type": "bar",
                "xkey": "Value",
                "ykey": "Category",
    ...
    ::: tab section_name="By ethnicity" tab_name="Data"
        ::: data_table
            {
                "title": "Percentage of FSM-eligible pupils meeting the expected standard in reading, writing and maths at key stage 2, by ethnicity (England, school year 2021 to 2022)",
                "dataTable": "1.0/IN12-attainment-at-age-11--by-ethnicity-and-FSM--table-format.csv",
                "dataTableAlignColumns": ["left", "right", "right"]
            }
        :::
    :::
...
::: download_full_dataset_link data_file="1.0/IN12-attainment-at-age-11--full-dataset.csv" :::
