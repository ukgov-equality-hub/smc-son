...
::: tabs
        ...
        ::: visualisation vis_type="chart" section_name="By socio-economic background"
            {
                ...
                "tooltipTitle": "",
                "data": "3.0/IN31-3.0-economic-activity--by-SEB--chart-format.csv",
                "height": 450,
                "type": "bary",
    ...
    ::: tab section_name="By socio-economic background" tab_name="Data"
        ::: data_table
            {
                "title": "Percentage of 25 to 29 year olds who were economically active, by socio-economic background (UK, 2024)",
                "dataTable": "3.0/IN31-3.0-economic-activity--by-SEB--table-format.csv",
...
::: tabs
        ...
        ::: visualisation vis_type="chart" section_name="Changes over time"
            {
                ...
                "tooltipTitle": "",
                 "data": [{
                    "label": "Men",
                    "data": "3.0/IN31-3.0-economic-activity--by-moving-average--men--chart-format.csv"
                }, {
                    "label": "Women",
                    "data": "3.0/IN31-3.0-economic-activity--by-moving-average--women--chart-format.csv"
                }, {
                    "label": "Total",
                    "data": "3.0/IN31-3.0-economic-activity--by-moving-average--total--chart-format.csv"
                }],
                "toggle": "radio",
                "height": 450,
                "type": "liney",
    ...
    ::: tab section_name="Changes over time" tab_name="Data"
        ::: data_table
            {
                "title": "Percentage of 25 to 29 year olds who were economically active by socio-economic background and sex (UK,  2014 to 2024, 3-year averages)",
                "dataTable": "3.0/IN31-3.0-economic-activity--by-moving-average--table-format.csv",
...
::: tabs
        ...
        ::: visualisation vis_type="chart" section_name="By sex"
            {
                ...
                "tooltipTitle": "",
                "data": "3.0/IN31-3.0-economic-activity--by-SEB-and-sex--chart-format.csv",
                "height": 450,
                "type": "bary",
    ...
    ::: tab section_name="By sex" tab_name="Data"
        ::: data_table
            {
                "title": "Percentage of 25 to 29 year olds who were economically active, by sex and socio-economic background (UK, 2014 to 2024 combined)",
                "dataTable": "3.0/IN31-3.0-economic-activity--by-SEB-and-sex--table-format.csv",
...
::: tabs
        ...
        ::: visualisation vis_type="chart" section_name="By ethnicity"
            {
                ...
                "tooltipTitle": "",
                "data": "3.0/IN31-3.0-economic-activity--by-SEB-and-ethnicity--chart-format.csv",
                "height": 450,
                "type": "bary",
                "xkey": "secondary_split_value",
                "ykey": "value",
    ...
    ::: tab section_name="By ethnicity" tab_name="Data"
        ::: data_table
            {
                "title": "Percentage of 25 to 29 year olds who were economically active, by ethnicity and socio-economic background (UK, 2014 to 2024 combined)",
                "dataTable": "3.0/IN31-3.0-economic-activity--by-SEB-and-ethnicity--table-format.csv",
                "dataTableAlignColumns": ["left", "right", "right"],
                "dataTableDecimalPlaces": [null, 1, 1]
            }
        :::
...
::: tabs
        ...
        ::: visualisation vis_type="chart" section_name="By disability status"
            {
                ...
                "tooltipTitle": "",
                "data": "3.0/IN31-3.0-economic-activity--by-SEB-and-disability--chart-format.csv",
                "height": 450,
                "type": "bary",
                "xkey": "tertiary_split_value",
                "ykey": "value",
    ...
    ::: tab section_name="By disability status" tab_name="Data"
        ::: data_table
            {
                "title": "Percentage of 25 to 29 year olds who were economically active, by disability status and socio-economic background (UK, 2014 to 2024 combined)",
                "dataTable": "3.0/IN31-3.0-economic-activity--by-SEB-and-disability--table-format.csv",
                "dataTableAlignColumns": ["left", "right", "right"],
                "dataTableDecimalPlaces": [null, 1, 1]
            }
        :::
...
::: tabs
        ...
        ::: visualisation vis_type="map" section_name="By area"
            {
                ...
                "data": "3.0/IN31-3.0-economic-activity--by-ITL2-region--chart-format.csv",
                "geoFormat": "",
                "nameField": "area_name",
                "valueField": "value",
                "areaField": "ITL221NM",
    ...
    ::: tab section_name="By area" tab_name="Data"
        ::: data_table
            {
                "title": "Percentage point difference in the likelihood of being economically active at 25 to 29 years old, compared to the national average (UK, 2018 to 2024 combined)",
                "dataTable": "3.0/IN31-3.0-economic-activity--by-ITL2-region--table-format.csv",
                "dataTableAlignColumns": ["left", "right"],
...
::: download_full_dataset_link data_file="3.0/IN31-3.0-economic-activity--full-dataset.csv" :::
