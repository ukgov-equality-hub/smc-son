...
::: tabs
    ::: tab section_name="Relative differences" tab_name="Visualisation"
        #### Percentage differences in hourly earnings of 25 to 29 year olds, relative to those with lower level qualifications (below CSE grade 1 or equivalent), controlling for socio-economic background, sex and age (UK, 2022 to 2024 combined)

        ::: visualisation vis_type="chart" section_name="Relative differences"
            {
                "code": "IN35",
                "title": "Percentage differences in hourly earnings of 25 to 29 year olds, relative to those with lower level qualifications (below CSE grade 1 or equivalent), controlling for socio-economic background, sex and age (UK, 2022 to 2024 combined)",
                "tooltipTitle": "",
                "data": "4.0/IN35-4.0-income-returns-to-education--by-qualification--chart-format.csv",
                "height": 450,
                "type": "bary",
    ...
    ::: tab section_name="Relative differences" tab_name="Data"
        ::: data_table
            {
                "title": "Percentage differences in hourly earnings of 25 to 29 year olds, relative to those with lower level qualifications (below CSE grade 1 or equivalent), controlling for socio-economic background, sex and age (UK, 2022 to 2024 combined)",
                "dataTable": "4.0/IN35-4.0-income-returns-to-education--by-qualification--table-format.csv",
...
::: tabs
        ...
        ::: visualisation vis_type="chart" section_name="Changes over time"
            {
                ...
                "tooltipTitle": "",
                "data": "4.0/IN35-4.0-income-returns-to-education--by-moving-average--chart-format.csv",
                "height": 450,
                "type": "liney",
                "xkey": "time_period",
                "ykey": "value",
    ...
    ::: tab section_name="Changes over time" tab_name="Data"
        ::: data_table
            {
                "title": "Hourly earnings of 25 to 29 year olds, adjusted for inflation, by highest qualification controlling for socio-economic background, sex and age (UK, 2014 to 2024, 3-year averages)",
                "dataTable": "4.0/IN35-4.0-income-returns-to-education--by-moving-average--table-format.csv",
...
::: tabs
        ...
        ::: visualisation vis_type="chart" section_name="By sex"
            {
                ...
                "tooltipTitle": "",
                "data": "4.0/IN35-4.0-income-returns-to-education--by-sex--chart-format.csv",
                "height": 450,
                "type": "bary",
    ...
    ::: tab section_name="By sex" tab_name="Data"
        ::: data_table
            {
                "title": "Mean hourly earnings of 25 to 29 year olds, by educational level and sex, controlling for socio-economic background and age (UK, 2014 to 2024 combined)",
                "dataTable": "4.0/IN35-4.0-income-returns-to-education--by-sex--table-format.csv",
...
::: tabs
        ...
        ::: visualisation vis_type="chart" section_name="By ethnicity"
            {
                ...
                "tooltipTitle": "",
                "data": "4.0/IN35-4.0-income-returns-to-education--by-ethnicity--chart-format.csv",
                "height": 450,
                "type": "bary",
                "xkey": "primary_split_value",
                "ykey": "value",
    ...
    ::: tab section_name="By ethnicity" tab_name="Data"
        ::: data_table
            {
                "title": "Mean hourly earnings of 25 to 29 year olds, by educational level and ethnicity, controlling for socio-economic background and age (UK, 2014 to 2024 combined)",
                "dataTable": "4.0/IN35-4.0-income-returns-to-education--by-ethnicity--table-format.csv",
                "dataTableAlignColumns": ["left", "right", "right"],
                "dataTableDecimalPlaces": [null, 2, 2]
            }
        :::
...
::: tabs
        ...
        ::: visualisation vis_type="chart" section_name="By disability status"
            {
                ...
                "tooltipTitle": "",
                "data": "4.0/IN35-4.0-income-returns-to-education--by-disability--chart-format.csv",
                "height": 450,
                "type": "bary",
                "xkey": "secondary_split_value",
                "ykey": "value",
    ...
    ::: tab section_name="By disability status" tab_name="Data"
        ::: data_table
            {
                "title": "Mean hourly earnings of 25 to 29 year olds, by educational level and disability status, controlling for socio-economic background and age (UK, 2014 to 2024 combined)",
                "dataTable": "4.0/IN35-4.0-income-returns-to-education--by-disability--table-format.csv",
                "dataTableAlignColumns": ["left", "right", "right"],
                "dataTableDecimalPlaces": [null, 2, 2]
            }
        :::
...
For data by education level, the percentages shown are the differences in income for men aged 27 from lower working class backgrounds by level of qualification, compared with similar men with lower level qualifications (below CSE grade 1 or equivalent). Data from 2022 to 2024 is combined to get more accurate estimates.
...
::: download_full_dataset_link data_file="4.0/IN35-4.0-income-returns-to-education--full-dataset.csv" :::
