...
In the same time period, the percentage in:

* all professional occupations (higher or lower) went up from 39% to 46%
* higher working class occupations went down from 19% to 15%
* all working class occupations (higher or lower) went down from 40% to 35%
