...
data = data_frame__remove_columns(
  ...
  # add a space to the start of the years formatted like 2011/12 so Excel doesn't convert them to dates like Dec-2011
  secondary_split_value = paste0(" ", secondary_split_value),
  time_period = paste0(" ", time_period))
