...
data_for_section$tertiary_split_value <- replace_na(data_for_section$tertiary_split_value, "Total") 


#################
# CHART FORMAT

for (sex in men_women_order_w_total) {
...
pivot_table = pivot_table__create(
  ...
  pivot_columns_column_2_name = "secondary_split_value",
  ...
  pivot_table_columns_order_values = men_women_order_w_total,
...
data_for_section = data_frame__sort_rows_with_specific_values(
  ...
  values_1 = sort(
    unique(data_for_section$tertiary_split_value)),
  column_2 = "secondary_split_value",
  values_2 = occupational_class_order
)
