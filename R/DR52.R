...
pivot_table = pivot_table__create(
  ...
  c("Business expenditure on R&D (£billions)"="billions of £")
)
...
pivot_table = pivot_table__create(
  ...
  c("Expenditure in millions of pounds per 100,000 people (£m)"="millions of £")
)
