...
pivot_table = pivot_table__create(
  ...
  pivot_table_columns_2_order_values = rev_occupational_class_order,
...
rename_profession_occupational_class = c(
  "lw"="Lower working",
  "hw"="Higher working",
  "int"="Intermediate",
  "lp"="Lower professional",
  "hp"="Higher professional"
)
...
pivot_table = pivot_table__create(
  pivot_table_source = data_for_section,
  pivot_columns_column_name = "background_label",
