...
section_chart_type = "seb_percentage"
...
) %>% rename("Percentage difference relative to lower working class" = "Percentage difference")
...
data_for_section = data_frame__sort_rows_with_specific_values(
  ...
  average_window = paste(secondary_split_value - 2, secondary_split_value, sep=" to "),
)
...
data_for_section = data_frame__sort_rows_with_specific_values(
  data_frame = data_for_section,
  column_1 = "primary_split_value",
  values_1 = rev(occupational_class_order_two_vals)
)
...
data_for_section = data_frame__sort_rows_with_specific_values(
  data_frame = data_for_section,
  column_1 = "secondary_split_value",
  values_1 = c("Disabled", "Not disabled"),
  column_2 = "primary_split_value",
  values_2 = rev_occupational_class_order,
)
